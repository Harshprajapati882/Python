...
002-Pips&Modules/
  Pips&Modules.md
  Pips&Modules.py       # runnable examples
  mypkg/
    __init__.py
    math_ops.py
```
...
```bash
python Pips&Modules.py
```

Or open `Pips&Modules.py` to see example usage.
...
From the `002-Pips&Modules` folder run:
...
- Pips examples: [Pips&Modules.py](Pips&Modules.py)
